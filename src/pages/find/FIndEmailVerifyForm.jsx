...
import { useEmailCodeVerify } from './../../hooks/uesEmailCodeVerify';

const FindEmailVerifyForm = ({ email }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  // 인증번호 검증 훅 가져오기
  const emailVerifyMutation = useEmailCodeVerify();
...
export default FindEmailVerifyForm;
