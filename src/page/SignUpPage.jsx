...
const SignUpPage = () => {
  ...
  return (
    <div className='h-[70vh] flex-col items-center'>
      <div className="w-[30vw] mx-auto bg-white p-6">
        <form className='space-y-4'>
          {signUpList.map((menu, index) => (
              <div key={index} className='flex items-center justify-between'>
                ...
                {index === 7 ? (
                  <div className="flex items-center w-[20vw] justify-between">
                    <div>
                      <input 
                        className=""
                        name="gender"
                  ...
                  <input 
                    className={`w-[20vw] h-[3vh] border bg-gray-200 border-amber-50`}
                    type="text"
                    placeholder={index === 8 ? 'YYYY / MM / DD' : ''}
                    id={'birthday1'}
                />
                )}
              </div>
      ...
      <div className="w-[30vw] mx-auto bg-white p-6 border-t-1 border-gray-300">
        <form className='space-y-4'>
          <div className='flex items-center justify-between'>
            <label>이용약관</label>
            <div className='text-sm overflow-y-auto w-[20vw] h-[20vh] bg-gray-100'>
            가. 개인정보의 수집 및 이용 목적
